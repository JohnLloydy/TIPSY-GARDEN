...
const Products = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            <div>
                ...
                <EditOutlined className='cart-edit' onClick={() => {setEditProduct(record); setPopModel(true)}} />
            </div>
    ...
    return (
        <LayoutApp >
            <h2>All Products</h2>
            <Button className='add-new' onClick={() => setPopModel(true)}>Add New</Button>
            <Table dataSource={productData} columns={columns} bordered/>;
            
            {
                popModel && 
                <Modal title={`${editProduct !== null ? "Edit Product": "Add New Product"}`} visible=
                {popModel} onCancel={() => {setEditProduct(null); setPopModel(false);}} footer={false}>
                    <Form layout='vertical' initialValues={editProduct} onFinish={HandlerSubmit}>
                        ...
                        <FormItem name="category" label="Category">
                            <Select>
                            <Select.Option value="Calthea"></Select.Option>
                            <Select.Option value="Petunia"></Select.Option>
                            <Select.Option value="Ctenanthe"></Select.Option>
                            <Select.Option value="Maranta"></Select.Option>
                            <Select.Option value="Flower"></Select.Option>
                            <Select.Option value="Plants"></Select.Option>
                            </Select>
                        </FormItem>
